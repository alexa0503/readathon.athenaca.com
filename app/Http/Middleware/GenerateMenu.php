...
class GenerateMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::make('menu', function ($menu) use ($admin) {
            ...
            //页面管理
            if (($admin->hasPermissionTo('页面管理') && $admin->hasAnyRole(['管理员'])) || $admin->hasAnyRole(['超级管理员'])) {
            ...
            //城市管理
            if (($admin->hasPermissionTo('城市管理') && $admin->hasAnyRole(['管理员'])) || $admin->hasAnyRole(['超级管理员'])) {
            ...
            //用户管理
            if (($admin->hasPermissionTo('用户管理') && $admin->hasAnyRole(['管理员'])) || $admin->hasAnyRole(['超级管理员'])) {
            ...
            //权限管理
            if (($admin->hasPermissionTo('权限管理') && $admin->hasAnyRole(['管理员'])) || $admin->hasAnyRole(['超级管理员'])) {
