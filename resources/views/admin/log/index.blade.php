...
<div class="smart-widget">
    <div class="smart-widget-header">
        <form class="form-inline" action="{{ route('log.index') }}">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('log.destroy',['id'=>$item->id])}}" class="btn destroy btn-default btn-xs">删除</a>
                            @if(Request::input('type') == 'prize')
                            @if($item->has_checked == 0)<a href="{{route('log.check',['id'=>$item->id])}}" class="btn checked btn-default btn-xs">核销</a>@else
                            <a href="{{route('log.uncheck',['id'=>$item->id])}}" class="btn checked btn-default btn-xs">撤销核销</a>@endif
                            @endif
                        </td>
                    </tr>
                    @endforeach
