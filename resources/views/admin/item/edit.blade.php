		...
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="{{ $item->words_number }}" name="words_number" type="text" class="form-control" id="words_number" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="{{ $item->total_number }}" name="total_number" type="text" class="form-control" id="total_number" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <select multiple name="cities[]" class="form-control select2" id="cities">
                            ...
                            <option value="{{ $city->id }}"{!! in_array($city->id, $item->city_ids) ? 'selected="selected"' : '' !!}>{{ $city->name }}</option>
                            @endforeach
                        </select>
