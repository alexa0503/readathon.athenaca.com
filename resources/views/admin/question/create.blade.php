    ...
    <div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                {{ Form::open(array('route' => ['question.store'], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'post-form')) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5 col-md-5">
                        <input value="" name="start_date" type="text" class="datepicker form-control" id="start_date" placeholder="">
                        <label class="help-block" for="" id="help-start_date"></label>
                    </div>
                    <div class="col-lg-5 col-md-5">
                        <input value="" name="end_date" type="text" class="datepicker form-control" id="end_date" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="" name="rewarded_number" type="text" class="form-control" id="rewarded_number" placeholder="">
