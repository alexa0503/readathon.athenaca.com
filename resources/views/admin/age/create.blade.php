    ...
    <div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                {{ Form::open(array('route' => ['age.store'], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'post-form')) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="" name="min_age" type="text" class="form-control" id="min_age" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="" name="max_age" type="text" class="form-control" id="max_age" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input name="sort_id" type="text" class="form-control" value="{{ $sort_id }}" id="sort_id" placeholder="">
